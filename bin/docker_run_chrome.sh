...
docker run -it --rm --net host --cpuset-cpus 0 --memory 512mb -v /tmp/.X11-unix:/tmp/.X11-unix -e DISPLAY=docker.for.mac.host.internal:0 -v $HOME/Shared/Docker/Volumes/google-chrome/:/data --security-opt seccomp=$HOME/Shared/Docker/seccomp/chrome.json --name chrome jess/chrome
